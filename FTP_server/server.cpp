...
//SOCKET
		 ...
		 if (argc == 2) {
			 localaddr.sin_port = htons((u_short)atoi(argv[1])); //ipv4 only, needs replacing. In our lectures, we have an //elegant way of resolving the local address and port to //be used by the server.				
		 }
		 else {
